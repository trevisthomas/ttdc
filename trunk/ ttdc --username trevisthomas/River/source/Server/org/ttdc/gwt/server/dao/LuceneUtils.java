...
public class LuceneUtils {
	...
	public synchronized static String prepPhraseForLucene(String original, DateRange dateRange){
	...
	public synchronized static String prepPhraseForLucene2(String original, DateRange dateRange){
		String phrase;

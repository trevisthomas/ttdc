...
public class RSSFeedWriter {
	...
	public RSSFeedWriter(Feed rssfeed, String outputFile) throws FileNotFoundException {
		this(rssfeed, new FileOutputStream(outputFile));
	}
	
	public RSSFeedWriter(Feed rssfeed, OutputStream outputStream){
	...
	public void write() throws Exception {
		...
		createNode(eventWriter, "pubDate", rssfeed.getPubDateString());
		...
		for (FeedMessage entry : rssfeed.getMessages()) {
			...
			if(entry.getPubDate() != null){
				createNode(eventWriter, "pubDate", entry.getPubDateString());
			}
			eventWriter.add(end);

...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "flipcards" because\n';
  ...
  $wnd.__gwt_activeModules['flipcards'] = {
 ...
 * "/flipcards.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['flipcards'].superdevmode = true;

  var expectedSuffix = '/flipcards.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + flipcards + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:flipcards';
  var devModeSessionKey = '__gwtDevModeSession:flipcards';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/flipcards/flipcards.nocache.js';
  ...
  $wnd.__gwt_activeModules['flipcards'].canRedirect = true;
  $wnd.__gwt_activeModules['flipcards'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/flipcards?user.agent=' + ua + '&_callback=' + callback;

...
/**
 * This class will encode a string to url safe and decode the string.  It uses
 * UTF-8 encoding.
 * 
 * The java.net.URLEncoder class wont decode. :-(  I needed to encode and decode
 * to have safe cookies for IE
 * 
 * @author trevis
 *
 */

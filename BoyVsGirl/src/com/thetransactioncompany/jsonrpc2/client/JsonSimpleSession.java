 ...
 */
public class JsonSimpleSession {
	 ...
	 */
	public JsonSimpleSession (final URL url) {
	 ...
	 */
	public JsonSimpleResponse send(final JSONRPC2Request request)
		throws JSONRPC2SessionException, JsonParseException, JsonMappingException, IOException {
		...
		Map<String, Object> map;
			...
			map = mapper.readValue(rawResponse.getContent(), Map.class);
				
		//ArgoParser.parse(rawResponse.getContent());
		JsonSimpleResponse response = new JsonSimpleResponse(map);	

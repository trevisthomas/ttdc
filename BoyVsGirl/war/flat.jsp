...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:zf="http://www.zenfolio.com/xml/page-schema" xml:lang="en">
	...
	PhotoSet photoSet = zenfolio.loadPhotoSetAsCollection("356653574"); //20547770
	%>
...
<div id="logo-block" >
   	<span id="logo-small"><a href="http-://www.boyvsgirlphotography.com"><img src="http://cdn.zenfolio.net/img/s11/v36/u603512342-71.png"/></a></span>
</div>
...
<div class="layout-frame layout-bgcolor1 layout-bgimage1 layout-fixed visitor">
    ...
    <div>
		...
		for(Photo p : photoSet.getPhotos()){
	 	%>
	 		...
	 		<a href="<%=p.getPageUrl()%>"><img src="<%=p.getXxLarge()%>" title="<%=p.getCreator()%>"></img></a><br>
    ...
    <div id="ctl02_ctl02" class="filler clear line0"></div>

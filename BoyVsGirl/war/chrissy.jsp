...
<title>Boy vs Girl Photography | Chrissy</title>
...
<body style="overflow:auto; min-height:100%;">
	...
	PhotoSet photoSet = zenfolio.loadPhotoSetPhotos("143596818", pageNumber); //20547770
	%>
	...
	<nav id="page-nav"> 
		<a href="chrissy.jsp?pageNumber=<%=pageNumber+1%>"> Next </a> 
	</nav>

...
<%	
	...
	PhotoSet photoSet = zenfolio.loadPhotoSet("31637159");
%>
<rss version="2.0" xmlns:media="http://search.yahoo.com/mrss/" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
        <title>Trevis' Showcase: Boy vs Girl Photography</title>
        <link>http://www.boyvsgirlphotography.com/showcase.jsp?who=trevis</link> 
        <description>Trevis's favorite images.</description>
...
for(Photo photo : photoSet.getPhotos()){
	...
	String permaLink = "http://www.boyvsgirlphotography.com/showcase.jsp?who=trevis&amp;show="+photo.getXxLarge();
%>
	    <item>
